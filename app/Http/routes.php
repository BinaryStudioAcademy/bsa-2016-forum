...
//    Route::delete('topics/{topic}/comments/{comment}','CommentController@destroyTopicComment')->name('deleteTopicComment');
//    Route::get('topics/{topic}/comments/{comment}/comments','CommentController@getTopicCommentChildren')->name('topicCommentChildren');
//
...
//    Route::get('votes/{vote}/comments/{comment}/comments','CommentController@getVoteCommentChildren')->name('voteCommentChildren');
//
//    /*Routes for VoteItem comments*/
//    Route::get('votes/{vote}/voteitem/{voteitem}/comments','CommentController@getVoteItemComments')->name('voteItemComments');
//    Route::post('votes/{vote}/voteitem/{voteitem}/comments','CommentController@storeVoteItemComment')->name('storeVoteItemComment');
//    Route::get('votes/{vote}/voteitem/{voteitem}/comments/{comment}','CommentController@getVoteItemComment')->name('voteItemComment');
